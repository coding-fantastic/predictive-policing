...
while ($row = mysqli_fetch_array($result)){
  ...
  Domestic_Violence","Drug_Possession","Extortion","Fraud","Harassment","Homicide","Human_Trafficking","Identity_Theft","Kidnaing","Manslaughter","
  Money_Laundering","Murder","Probation_Violation","Poaching","Rape","Robbery","Sexual_Assault","Shoplifting","Stalking","Tax_Evasion","Vandalism","
  White_Collar_Crimes");
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      ...
      <ul class="navbar-nav " >
        <li>
          <a class="nav-link" href="http://localhost/websites/train/home.php">Sign out</a>
        </li>
      </ul>
    </div>
  </nav>
...
<p>Now showing result for: <strong><?php echo $county; ?></strong></p>
